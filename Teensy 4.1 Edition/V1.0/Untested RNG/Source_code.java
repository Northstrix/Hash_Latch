...
public class MainClass {
    ...
    public static void gen_keys() {
		...
		disp_rec("String spart = \"");
		SecureRandom sk0hk11 = new SecureRandom();
		for (int i = 0; i < 30; i++) {
			SecureRandom sk0111 = new SecureRandom();
				m = sk0111.nextInt(3);
				m1 = sk0111.nextInt(2);
				StringBuilder str01 = new StringBuilder();
				if (m == 0)
					str01.append((char)(65 + (sk0111.nextInt(26))));
				if (m == 1)
					str01.append((char)(97 + (sk0111.nextInt(26))));
				if (m == 2)
					str01.append((char)(48 + (sk0111.nextInt(10))));
				disp_rec(str01.toString());
		}
		disp_rec("\";\n");
		
		disp_rec("const char right_prefix[5] = {'0', '0', '0', '0', '0'};\n");
	  ...
	  public static void main(String[] args){
	      ...
	      */
		  StringBuilder slt = new StringBuilder();
	        ...
	        JButton genr = new JButton("Generate keys for Hash Latch");
